...
const DeleteTipModal = ({ isOpen, onClose, onConfirm, tip }) => {
      ...
      <div className="bg-white w-full max-w-md rounded-2xl shadow-xl overflow-hidden">
        ...
        <div className="flex gap-3 justify-end p-6 border-t border-gray-200 bg-gray-50">
          ...
          <button
            ...
            className="px-4 py-2.5 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors duration-200 font-medium"
          >
            Delete Tip
          </button>
        </div>
