    ...
    >
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
        <div className="min-w-0">
          <h3 className="text-lg sm:text-xl md:text-2xl font-semibold text-[#2FA394] break-words truncate">
            {breed}
          </h3>
        ...
        {/* Confidence Badge */}
        <div className={`mt-2 sm:mt-0 self-start sm:self-auto px-3 py-1.5 rounded-full text-white text-xs font-semibold ${getConfidenceColor()}`}>
      ...
      <div className="flex flex-col xs:flex-row gap-2 mt-2">
        <button
          onClick={handleReset}
          className="flex-1 px-3 sm:px-4 py-2 bg-[#2FA394] text-white font-medium rounded-lg text-xs sm:text-sm hover:bg-[#23876f] transition-all shadow-sm flex items-center justify-center gap-2"
        >
