    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
      {records.length === 0 ? (
        <div className="col-span-3 text-center py-8 text-gray-500">
          <i className="fas fa-file-medical text-4xl mb-3 text-gray-300"></i>
        ...
        records.map((record, index) => (
          ...
          >
            <div className="flex items-center gap-3 mb-3">
              <i className={`fa-solid ${getRecordIcon(record)} text-[#5EE6FE] text-lg`}></i>
            ...
            {record.fileID ? (
              <button
                ...
                className="bg-[#5EE6FE] text-white px-4 py-2 rounded-lg font-medium text-sm hover:bg-[#3ecbe0] transition-all w-full"
              >
