...
return (
<section id="services-with-prices" className="bg-white py-1 px-6 sm:px-12 lg:px-20">
...
<h2 className="text-3xl font-bold text-gray-800 mb-8 text-center">PAWS Services & Pricing</h2>


<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
<div className="bg-gray-50 border-2 border-[#5EE6FE] rounded-lg p-6 shadow-sm hover:shadow-md transition duration-200">
  <h3 className="text-xl font-semibold text-[#263238] mb-2">Consultation</h3>
           <p className="text-[#5EE6FE] font-bold">Fees may vary</p>
        <p className="text-sm text-gray-600 mb-2">
          Our veterinary consultations provide expert guidance to ensure your pets stay healthy and well-cared for. From routine check-ups to addressing specific health concerns, our experienced team takes the time to understand your pet’s needs and provide advice for their overall well-being.
        </p>
      ...
      {/* Vaccination */}
      <div className="bg-gray-50 border-2 border-[#5EE6FE] rounded-lg p-6 shadow-sm hover:shadow-md transition duration-200">
        <h3 className="text-xl font-semibold text-[#263238] mb-2">Vaccination</h3>
        <p className="text-sm text-gray-600 mb-2">
          We protect your pets from harmful diseases with our comprehensive vaccination services. We provide safe and effective vaccines tailored to your pet’s needs, ensuring their long-term health and wellness.
        </p>
        <ul className="text-sm text-gray-600 space-y-1 mt-2">
          <li>5-in-1 Vaccine – ₱600</li>
          <li>8-in-1 Vaccine – ₱600</li>
          <li>Anti-Rabies Vaccine – ₱250</li>
          <li>Kennel Cough Vaccine – ₱250</li>
          <li>4-in-1 Vaccine – ₱850</li>
        </ul>
      </div>

      {/* Basic Soft Tissue Surgery */}
      <div className="bg-gray-50 border-2 border-[#5EE6FE] rounded-lg p-6 shadow-sm hover:shadow-md transition duration-200">
        <h3 className="text-xl font-semibold text-[#263238] mb-2">Basic Soft Tissue Surgery</h3>
         <p className="text-[#5EE6FE] font-bold">Costs may vary</p>
        <p className="text-sm text-gray-600 mb-2">
          Our clinic provides safe and reliable soft tissue surgeries to address common health issues in pets, such as lump removals, wound repairs, or mass/gland removals. With modern facilities and experienced veterinarians, we ensure your pets receive gentle, expert care throughout the procedure.
        </p>
      ...
      <div className="bg-gray-50 border-2 border-[#5EE6FE] rounded-lg p-6 shadow-sm hover:shadow-md transition duration-200">
        <h3 className="text-xl font-semibold text-[#263238] mb-2">Blood Chemistry Laboratory</h3>
        <p className="text-[#5EE6FE] font-bold mb-2">₱2,800</p>
        <p className="text-sm text-gray-600">
          Our blood chemistry tests provide vital insights into your pet’s overall health, including organ function, hydration, and possible underlying conditions. This service helps us detect issues early and create the right treatment plan for your dog or cat.
        </p>
      </div>
      ...
      {/* CBC */}
      <div className="bg-gray-50 border-2 border-[#5EE6FE] rounded-lg p-6 shadow-sm hover:shadow-md transition duration-200">
        <h3 className="text-xl font-semibold text-[#263238] mb-2">Complete Blood Count (CBC)</h3>
        <p className="text-[#5EE6FE] font-bold mb-2">₱950</p>
        <p className="text-sm text-gray-600">
          A complete blood count is an essential test to evaluate your pet’s overall health. It helps detect infections, anemia, immune system issues, and other conditions that may not be visible through routine check-ups. Regular CBC testing ensures early detection and timely care for your pets.
        </p>
      </div>

      {/* Health Certificate */}
      <div className="bg-gray-50 border-2 border-[#5EE6FE] rounded-lg p-6 shadow-sm hover:shadow-md transition duration-200">
        <h3 className="text-xl font-semibold text-[#263238] mb-2">Veterinary Health Certificate</h3>
        <p className="text-[#5EE6FE] font-bold mb-2">₱750</p>
        <p className="text-sm text-gray-600">
          A veterinary health certificate provides official proof that your pet is healthy and fit for travel, adoption, or other requirements. Our licensed veterinarians will examine your dog or cat thoroughly to ensure they meet all health standards before issuing the certificate.
        </p>
      </div>

      {/* Microchipping */}
      <div className="bg-gray-50 border-2 border-[#5EE6FE] rounded-lg p-6 shadow-sm hover:shadow-md transition duration-200">
        <h3 className="text-xl font-semibold text-[#263238] mb-2">Microchipping</h3>
        <p className="text-[#5EE6FE] font-bold mb-2">Pricing may vary depending on the type of microchip and registration requirements.</p>
        <p className="text-sm text-gray-600">
          Microchipping is a safe and permanent way to identify your pets and ensure they can always find their way back to you if lost. The tiny microchip is quickly implanted under your pet’s skin and linked to your contact information, giving you peace of mind and added security for your beloved companion.
        </p>
      </div>

      {/* Confinement */}
      <div className="bg-gray-50 border-2 border-[#5EE6FE] rounded-lg p-6 shadow-sm hover:shadow-md transition duration-200">
        <h3 className="text-xl font-semibold text-[#263238] mb-2">Confinement</h3>
        <p className="text-[#5EE6FE] font-bold mb-2">Depends on duration & care</p>
        <p className="text-sm text-gray-600">
          For pets requiring close monitoring and extended care, our clinic offers safe and comfortable confinement facilities. Whether your pet is recovering from surgery, illness, or needs observation, our veterinary team ensures they receive round-the-clock attention and proper medical support.
        </p>
      </div>

      {/* Capon - Cats */}
      <div className="bg-gray-50 border-2 border-[#5EE6FE] rounded-lg p-6 shadow-sm hover:shadow-md transition duration-200">
        <h3 className="text-xl font-semibold text-[#263238] mb-2">Capon – Cats</h3>
        <p className="text-sm text-gray-600 mb-2">Male Cat – ₱1,000</p>
        <p className="text-sm text-gray-600 mb-2">Female Cat – ₱1,200</p>
        <p className="text-sm text-gray-600">
          Promotes pet health and population control with safe, caring procedures.
        </p>
      </div>

      {/* Capon – Dogs */}
      <div className="bg-gray-50 border-2 border-[#5EE6FE] rounded-lg p-6 shadow-sm hover:shadow-md transition duration-200">
        <h3 className="text-xl font-semibold text-[#263238] mb-2">Capon – Dogs</h3>
        <p className="text-sm text-gray-600 mb-2">Female: ₱2,500–₱5,500</p>
        <p className="text-sm text-gray-600 mb-2">Male: ₱2,250–₱5,000</p>
        <p className="text-sm text-gray-600">
          Price varies by weight. Ensures safe spaying/neutering with proper recovery support.
        </p>
      </div>

      {/* Dental Prophylaxis */}
      <div className="bg-gray-50 border-2 border-[#5EE6FE] rounded-lg p-6 shadow-sm hover:shadow-md transition duration-200">
        <h3 className="text-xl font-semibold text-[#263238] mb-2">Dental Prophylaxis</h3>
        <p className="text-sm text-gray-600 mb-2">1.0–10 kg – ₱5,000</p>
        <p className="text-sm text-gray-600 mb-2">15.1–19 kg – ₱7,000</p>
        <p className="text-sm text-gray-600">
          Good oral health is essential for your pet’s overall well-being. Our dental prophylaxis service includes thorough cleaning to prevent plaque, tartar buildup, and gum disease, helping your pets maintain healthy teeth and fresh breath.
        </p>
      </div>

      {/* Deworming */}
      <div className="bg-gray-50 border-2 border-[#5EE6FE] rounded-lg p-6 shadow-sm hover:shadow-md transition duration-200">
        <h3 className="text-xl font-semibold text-[#263238] mb-2">Deworming</h3>
        <p className="text-sm text-gray-600 mb-2">₱150–₱500 (based on weight)</p>
        <p className="text-sm text-gray-600">
          Protect your pets from harmful internal parasites with our safe and effective deworming service. Regular deworming ensures your dogs and cats stay healthy, active, and free from intestinal worms.
...
{/* start of services with prices */}

<section id="services-with-prices" className="bg-white py-16 px-6 sm:px-12 lg:px-20">
  <div className="max-w-7xl mx-auto">
    <h2 className="text-3xl font-bold text-gray-800 mb-8 text-center">PAWS Services & Pricing</h2>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      <div className="bg-gray-50 border-2 border-[#5EE6FE] rounded-lg p-6 shadow-sm hover:shadow-md transition duration-200">
        ...
        <p className="text-sm text-gray-600 mb-2">₱150–₱500 (based on weight)</p>
        <p className="text-sm text-gray-600">
          Protects pets from internal parasites. Regular treatment keeps them active and healthy.
        </p>
      </div>
    ...
    <div className="mt-12 text-center">
      <a href="#schedule" className="inline-block bg-[#5EE6FE] text-white px-8 py-4 rounded-lg font-bold shadow-md transform transition duration-200 hover:shadow-xl hover:-translate-y-0.5">
        Schedule a Visit →
      </a>
    </div>
  </div>
